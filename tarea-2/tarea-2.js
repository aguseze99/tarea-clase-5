...
const botonInformacion = document.querySelector('#enviar-informacion')
botonInformacion.onclick = function(e){
    ...
    const mensaje = `Bienvenido ${nombreUsuario} ${apellidoUsuario}, de edad ${edadUsuario} `

    document.querySelector('#saludo').innerText = mensaje
